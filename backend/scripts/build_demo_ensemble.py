...
NOTE = (
    ...
    "1.18 / 0.66 / 0.35 / 0.13 C and p95 0.42 / 0.60 / 0.35 / 0.29 C at N = "
    "64 / 128 / 300 / 600. NEITHER EDGE REACHES 0.1 C AT ANY N TESTED, and the same is "
    "true of the pcg64 arm, which is worse at every N - its p95 sd is 2.33 C at N=64 "
    "against Sobol's 0.42. The lower edge falls roughly as 1/sqrt(N); the upper edge "
    "improves only 18 percent over the last doubling, so it is not settling and no "
    "extrapolation to the N used here is trustworthy - an earlier version of this note "
    "extrapolated to 0.12-0.15 C and the N=600 measurement did not support it. Read the "
    "upper edge to about 0.3 C and the lower to about 0.15 C, not to the precision they "
    "are printed at. "
